...
#define _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE(view, data_copy_from, offset, len) \
    { \
        ...
        memcpy((void*)(dst), (void*)data_copy_from, len); \
    }
...
#define _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data_copy_to, offset, len) \
    { \
       size_t len_to_copy = len + offset < view.length ? len : view.length - offset; \
       memcpy(data_copy_to, view.data, len_to_copy); \
       return len_to_copy; \
    }
...
SBE_ONE_DEF double sbe_double_nan()
{
    ...
    val.uint_value = 0xFFFFFFFF7FF7FFFFLLU;
    return val.fp_value;
}
#endif
...
struct sbe_string_view
{
    ...
    char get_unsafe(size_t index)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_AT((*this), index, char);
    }
    size_t get(char *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_GET_RANGE((*this), ptr, offset, len);
    }
    size_t get_unsafe(char *ptr, size_t offset, size_t len)
    {
...
SBE_ONE_DEF bool sbe_string_view_set(sbe_string_view view, const char *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_string_view_set_at(sbe_string_view view, size_t index, char val)
{
    _SBE_BUFFER_VIEW_SAFE_SET_AT(view, index, val);
}

SBE_ONE_DEF void sbe_string_view_set_at_unsafe(sbe_string_view view, size_t index, char val)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_AT(view, index, val);
}

SBE_ONE_DEF bool sbe_string_view_set_range(sbe_string_view view, const char *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_SET_RANGE(view, data, offset, len);
}

SBE_ONE_DEF void sbe_string_view_set_range_unsafe(sbe_string_view view, const char *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE(view, data, offset, len);
}

SBE_ONE_DEF size_t sbe_string_view_get(sbe_string_view view, char *data, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, 0, len);
}

SBE_ONE_DEF size_t sbe_string_view_get_unsafe(sbe_string_view view, char *data, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data, 0, len);
}

SBE_ONE_DEF char sbe_string_view_get_at(sbe_string_view view, size_t index)
{
    _SBE_BUFFER_VIEW_SAFE_GET_AT(view, index, '\0', char);
}

SBE_ONE_DEF char sbe_string_view_get_at_unsafe(sbe_string_view view, size_t index)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_AT(view, index, char);
}

SBE_ONE_DEF size_t sbe_string_view_get_range(sbe_string_view view, char *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, offset, len);
}

SBE_ONE_DEF size_t sbe_string_view_get_range_unsafe(sbe_string_view view, char *data, size_t offset, size_t len)
{
...
struct sbe_int8_view
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const int8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_RANGE((*this), ptr, 0, len);
    }
    void set_unsafe(const int8_t *ptr)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, 0, length);
    }
    bool set(size_t index, int8_t val)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_AT((*this), index, val);
    }
    void set_unsafe(size_t index, int8_t val)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_AT((*this), index, val);
    }
    bool set(const int8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_RANGE((*this), ptr, offset, len);
    }
    void set_unsafe(const int8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, offset, len);
    }
    size_t get(int8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_GET_RANGE((*this), ptr, 0, len);
    }
    size_t get_unsafe(int8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE((*this), ptr, 0, len);
    }
    ...
    int8_t get_unsafe(size_t index)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_AT((*this), index, int8_t);
    }
    size_t get(int8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_GET_RANGE((*this), ptr, offset, len);
    }
    size_t get_unsafe(int8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE((*this), ptr, offset, len);
    }
#endif
...
SBE_ONE_DEF bool sbe_int8_view_set(sbe_int8_view view, const int8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_SET_RANGE(view, data, 0, len);
}
...
SBE_ONE_DEF bool sbe_int8_view_set_at(sbe_int8_view view, size_t index, int8_t val)
{
    _SBE_BUFFER_VIEW_SAFE_SET_AT(view, index, val);
}
SBE_ONE_DEF void sbe_int8_view_set_at_unsafe(sbe_int8_view view, size_t index, int8_t val)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_AT(view, index, val);
}
SBE_ONE_DEF bool sbe_int8_view_set_range(sbe_int8_view view, const int8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_SET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF void sbe_int8_view_set_range_unsafe(sbe_int8_view view, const int8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF size_t sbe_int8_view_get(sbe_int8_view view, int8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, 0, len);
}
SBE_ONE_DEF size_t sbe_int8_view_get_unsafe(sbe_int8_view view, int8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data, 0, len);
}
SBE_ONE_DEF int8_t sbe_int8_view_get_at(sbe_int8_view view, size_t index)
{
    _SBE_BUFFER_VIEW_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT8, int8_t);
}
SBE_ONE_DEF int8_t sbe_int8_view_get_at_unsafe(sbe_int8_view view, size_t index)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_AT(view, index, int8_t);
}
SBE_ONE_DEF size_t sbe_int8_view_get_range(sbe_int8_view view, int8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF size_t sbe_int8_view_get_range_unsafe(sbe_int8_view view, int8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data, offset, len);
}
...
SBE_ONE_DEF bool sbe_int16_view_be_set(sbe_int16_view_be view, const int16_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int16_view_be_set_at(sbe_int16_view_be view, size_t index, int16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_int16_view_be_set_at_unsafe(sbe_int16_view_be view, size_t index, int16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF bool sbe_int16_view_be_set_range(sbe_int16_view_be view, const int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_int16_view_be_set_range_unsafe(sbe_int16_view_be view, const int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_be_get(sbe_int16_view_be view, int16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_be_get_unsafe(sbe_int16_view_be view, int16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF int16_t sbe_int16_view_be_get_at(sbe_int16_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT16, int16_t ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF int16_t sbe_int16_view_be_get_at_unsafe(sbe_int16_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int16_t ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_be_get_range(sbe_int16_view_be view, int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_be_get_range_unsafe(sbe_int16_view_be view, int16_t *data, size_t offset, size_t len)
{
...
SBE_ONE_DEF bool sbe_int16_view_le_set(sbe_int16_view_le view, const int16_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int16_view_le_set_at(sbe_int16_view_le view, size_t index, int16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_int16_view_le_set_at_unsafe(sbe_int16_view_le view, size_t index, int16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF bool sbe_int16_view_le_set_range(sbe_int16_view_le view, const int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_int16_view_le_set_range_unsafe(sbe_int16_view_le view, const int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_le_get(sbe_int16_view_le view, int16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_le_get_unsafe(sbe_int16_view_le view, int16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF int16_t sbe_int16_view_le_get_at(sbe_int16_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT16, int16_t ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF int16_t sbe_int16_view_le_get_at_unsafe(sbe_int16_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int16_t ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_le_get_range(sbe_int16_view_le view, int16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_int16_view_le_get_range_unsafe(sbe_int16_view_le view, int16_t *data, size_t offset, size_t len)
{
...
SBE_ONE_DEF bool sbe_int32_view_be_set(sbe_int32_view_be view, const int32_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int32_view_be_set_at(sbe_int32_view_be view, size_t index, int32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_int32_view_be_set_at_unsafe(sbe_int32_view_be view, size_t index, int32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_int32_view_be_set_range(sbe_int32_view_be view, const int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_int32_view_be_set_range_unsafe(sbe_int32_view_be view, const int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_be_get(sbe_int32_view_be view, int32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_be_get_unsafe(sbe_int32_view_be view, int32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF int32_t sbe_int32_view_be_get_at(sbe_int32_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT32, int32_t ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF int32_t sbe_int32_view_be_get_at_unsafe(sbe_int32_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int32_t ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_be_get_range(sbe_int32_view_be view, int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_be_get_range_unsafe(sbe_int32_view_be view, int32_t *data, size_t offset, size_t len)
{
...
SBE_ONE_DEF bool sbe_int32_view_le_set(sbe_int32_view_le view, const int32_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int32_view_le_set_at(sbe_int32_view_le view, size_t index, int32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_int32_view_le_set_at_unsafe(sbe_int32_view_le view, size_t index, int32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_int32_view_le_set_range(sbe_int32_view_le view, const int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_int32_view_le_set_range_unsafe(sbe_int32_view_le view, const int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_le_get(sbe_int32_view_le view, int32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_le_get_unsafe(sbe_int32_view_le view, int32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF int32_t sbe_int32_view_le_get_at(sbe_int32_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT32, int32_t ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF int32_t sbe_int32_view_le_get_at_unsafe(sbe_int32_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int32_t ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_le_get_range(sbe_int32_view_le view, int32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_int32_view_le_get_range_unsafe(sbe_int32_view_le view, int32_t *data, size_t offset, size_t len)
{
...
SBE_ONE_DEF bool sbe_int64_view_be_set(sbe_int64_view_be view, const int64_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int64_view_be_set_at(sbe_int64_view_be view, size_t index, int64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_int64_view_be_set_at_unsafe(sbe_int64_view_be view, size_t index, int64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_int64_view_be_set_range(sbe_int64_view_be view, const int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_int64_view_be_set_range_unsafe(sbe_int64_view_be view, const int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_be_get(sbe_int64_view_be view, int64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_be_get_unsafe(sbe_int64_view_be view, int64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF int64_t sbe_int64_view_be_get_at(sbe_int64_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT64, int64_t ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF int64_t sbe_int64_view_be_get_at_unsafe(sbe_int64_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int64_t ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_be_get_range(sbe_int64_view_be view, int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_be_get_range_unsafe(sbe_int64_view_be view, int64_t *data, size_t offset, size_t len)
{
...
SBE_ONE_DEF bool sbe_int64_view_le_set(sbe_int64_view_le view, const int64_t *data, size_t len)
{
...
SBE_ONE_DEF bool sbe_int64_view_le_set_at(sbe_int64_view_le view, size_t index, int64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_int64_view_le_set_at_unsafe(sbe_int64_view_le view, size_t index, int64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_int64_view_le_set_range(sbe_int64_view_le view, const int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_int64_view_le_set_range_unsafe(sbe_int64_view_le view, const int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_le_get(sbe_int64_view_le view, int64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_le_get_unsafe(sbe_int64_view_le view, int64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF int64_t sbe_int64_view_le_get_at(sbe_int64_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_INT64, int64_t ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF int64_t sbe_int64_view_le_get_at_unsafe(sbe_int64_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, int64_t ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_le_get_range(sbe_int64_view_le view, int64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_int64_view_le_get_range_unsafe(sbe_int64_view_le view, int64_t *data, size_t offset, size_t len)
{
...
struct sbe_uint8_view
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const uint8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_RANGE((*this), ptr, 0, len);
    }
    void set_unsafe(const uint8_t *ptr)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, 0, length);
    }
    bool set(size_t index, uint8_t val)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_AT((*this), index, val);
    }
    void set_unsafe(size_t index, uint8_t val)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_AT((*this), index, val);
    }
    bool set(const uint8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_SET_RANGE((*this), ptr, offset, len);
    }
    void set_unsafe(const uint8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, offset, len);
    }
    size_t get(uint8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_GET_RANGE((*this), ptr, 0, len);
    }
    size_t get_unsafe(uint8_t *ptr, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE((*this), ptr, 0, len);
    }
    ...
    uint8_t get_unsafe(size_t index)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_AT((*this), index, uint8_t);
    }
    size_t get(uint8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_SAFE_GET_RANGE((*this), ptr, offset, len);
    }
    size_t get_unsafe(uint8_t *ptr, size_t offset, size_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE((*this), ptr, offset, len);
    }
#endif
...
SBE_ONE_DEF bool sbe_uint8_view_set(sbe_uint8_view view, const uint8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_SET_RANGE(view, data, 0, len);
}
...
SBE_ONE_DEF bool sbe_uint8_view_set_at(sbe_uint8_view view, size_t index, uint8_t val)
{
    _SBE_BUFFER_VIEW_SAFE_SET_AT(view, index, val);
}
SBE_ONE_DEF void sbe_uint8_view_set_at_unsafe(sbe_uint8_view view, size_t index, uint8_t val)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_AT(view, index, val);
}
SBE_ONE_DEF bool sbe_uint8_view_set_range(sbe_uint8_view view, const uint8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_SET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF void sbe_uint8_view_set_range_unsafe(sbe_uint8_view view, const uint8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF size_t sbe_uint8_view_get(sbe_uint8_view view, uint8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, 0, len);
}
SBE_ONE_DEF size_t sbe_uint8_view_get_unsafe(sbe_uint8_view view, uint8_t *data, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data, 0, len);
}
SBE_ONE_DEF uint8_t sbe_uint8_view_get_at(sbe_uint8_view view, size_t index)
{
    _SBE_BUFFER_VIEW_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT8, uint8_t);
}
SBE_ONE_DEF uint8_t sbe_uint8_view_get_at_unsafe(sbe_uint8_view view, size_t index)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_AT(view, index, uint8_t);
}
SBE_ONE_DEF size_t sbe_uint8_view_get_range(sbe_uint8_view view, uint8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_SAFE_GET_RANGE(view, data, offset, len);
}
SBE_ONE_DEF size_t sbe_uint8_view_get_range_unsafe(sbe_uint8_view view, uint8_t *data, size_t offset, size_t len)
{
    _SBE_BUFFER_VIEW_UNSAFE_GET_RANGE(view, data, offset, len);
}
...
struct sbe_uint16_view_be
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const uint16_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    void set_unsafe(const uint16_t *ptr)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, 0, length ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    bool set(size_t index, uint16_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    void set_unsafe(size_t index, uint16_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    bool set(const uint16_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    void set_unsafe(const uint16_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    size_t get(uint16_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    size_t get_unsafe(uint16_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    ...
    uint16_t get_unsafe(size_t index)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT((*this), index, uint16_t ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    size_t get(uint16_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    size_t get_unsafe(uint16_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
#endif
...
SBE_ONE_DEF bool sbe_uint16_view_be_set(sbe_uint16_view_be view, const uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
...
SBE_ONE_DEF bool sbe_uint16_view_be_set_at(sbe_uint16_view_be view, size_t index, uint16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_uint16_view_be_set_at_unsafe(sbe_uint16_view_be view, size_t index, uint16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF bool sbe_uint16_view_be_set_range(sbe_uint16_view_be view, const uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_uint16_view_be_set_range_unsafe(sbe_uint16_view_be view, const uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_be_get(sbe_uint16_view_be view, uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_be_get_unsafe(sbe_uint16_view_be view, uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF uint16_t sbe_uint16_view_be_get_at(sbe_uint16_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT16, uint16_t ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF uint16_t sbe_uint16_view_be_get_at_unsafe(sbe_uint16_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint16_t ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_be_get_range(sbe_uint16_view_be view, uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_be_get_range_unsafe(sbe_uint16_view_be view, uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
}
...
SBE_ONE_DEF bool sbe_uint16_view_le_set(sbe_uint16_view_le view, const uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
...
SBE_ONE_DEF bool sbe_uint16_view_le_set_at(sbe_uint16_view_le view, size_t index, uint16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_uint16_view_le_set_at_unsafe(sbe_uint16_view_le view, size_t index, uint16_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF bool sbe_uint16_view_le_set_range(sbe_uint16_view_le view, const uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF void sbe_uint16_view_le_set_range_unsafe(sbe_uint16_view_le view, const uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_le_get(sbe_uint16_view_le view, uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_le_get_unsafe(sbe_uint16_view_le view, uint16_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF uint16_t sbe_uint16_view_le_get_at(sbe_uint16_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT16, uint16_t ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF uint16_t sbe_uint16_view_le_get_at_unsafe(sbe_uint16_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint16_t ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_le_get_range(sbe_uint16_view_le view, uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
SBE_ONE_DEF size_t sbe_uint16_view_le_get_range_unsafe(sbe_uint16_view_le view, uint16_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_16, uint16_t);
}
...
struct sbe_uint32_view_be
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const uint32_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(const uint32_t *ptr)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, 0, length ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    bool set(size_t index, uint32_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(size_t index, uint32_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    bool set(const uint32_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(const uint32_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get(uint32_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get_unsafe(uint32_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    ...
    uint32_t get_unsafe(size_t index)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT((*this), index, uint32_t ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get(uint32_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get_unsafe(uint32_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
#endif
...
SBE_ONE_DEF bool sbe_uint32_view_be_set(sbe_uint32_view_be view, const uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_uint32_view_be_set_at(sbe_uint32_view_be view, size_t index, uint32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_uint32_view_be_set_at_unsafe(sbe_uint32_view_be view, size_t index, uint32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_uint32_view_be_set_range(sbe_uint32_view_be view, const uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_uint32_view_be_set_range_unsafe(sbe_uint32_view_be view, const uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_be_get(sbe_uint32_view_be view, uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_be_get_unsafe(sbe_uint32_view_be view, uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF uint32_t sbe_uint32_view_be_get_at(sbe_uint32_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT32, uint32_t ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF uint32_t sbe_uint32_view_be_get_at_unsafe(sbe_uint32_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint32_t ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_be_get_range(sbe_uint32_view_be view, uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_be_get_range_unsafe(sbe_uint32_view_be view, uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_uint32_view_le_set(sbe_uint32_view_le view, const uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_uint32_view_le_set_at(sbe_uint32_view_le view, size_t index, uint32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_uint32_view_le_set_at_unsafe(sbe_uint32_view_le view, size_t index, uint32_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_uint32_view_le_set_range(sbe_uint32_view_le view, const uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_uint32_view_le_set_range_unsafe(sbe_uint32_view_le view, const uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_le_get(sbe_uint32_view_le view, uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_le_get_unsafe(sbe_uint32_view_le view, uint32_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF uint32_t sbe_uint32_view_le_get_at(sbe_uint32_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT32, uint32_t ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF uint32_t sbe_uint32_view_le_get_at_unsafe(sbe_uint32_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint32_t ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_le_get_range(sbe_uint32_view_le view, uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_uint32_view_le_get_range_unsafe(sbe_uint32_view_le view, uint32_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
...
struct sbe_uint64_view_be
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const uint64_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(const uint64_t *ptr)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, 0, length ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    bool set(size_t index, uint64_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(size_t index, uint64_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    bool set(const uint64_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(const uint64_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get(uint64_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get_unsafe(uint64_t *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    ...
    uint64_t get_unsafe(size_t index)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT((*this), index, uint64_t ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get(uint64_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get_unsafe(uint64_t *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
#endif
...
SBE_ONE_DEF bool sbe_uint64_view_be_set(sbe_uint64_view_be view, const uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_uint64_view_be_set_at(sbe_uint64_view_be view, size_t index, uint64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_uint64_view_be_set_at_unsafe(sbe_uint64_view_be view, size_t index, uint64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_uint64_view_be_set_range(sbe_uint64_view_be view, const uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_uint64_view_be_set_range_unsafe(sbe_uint64_view_be view, const uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_be_get(sbe_uint64_view_be view, uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_be_get_unsafe(sbe_uint64_view_be view, uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF uint64_t sbe_uint64_view_be_get_at(sbe_uint64_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT64, uint64_t ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF uint64_t sbe_uint64_view_be_get_at_unsafe(sbe_uint64_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint64_t ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_be_get_range(sbe_uint64_view_be view, uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_be_get_range_unsafe(sbe_uint64_view_be view, uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_uint64_view_le_set(sbe_uint64_view_le view, const uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_uint64_view_le_set_at(sbe_uint64_view_le view, size_t index, uint64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_uint64_view_le_set_at_unsafe(sbe_uint64_view_le view, size_t index, uint64_t val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_uint64_view_le_set_range(sbe_uint64_view_le view, const uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_uint64_view_le_set_range_unsafe(sbe_uint64_view_le view, const uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_le_get(sbe_uint64_view_le view, uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_le_get_unsafe(sbe_uint64_view_le view, uint64_t *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF uint64_t sbe_uint64_view_le_get_at(sbe_uint64_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_NULLVALUE_UINT64, uint64_t ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF uint64_t sbe_uint64_view_le_get_at_unsafe(sbe_uint64_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, uint64_t ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_le_get_range(sbe_uint64_view_le view, uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_uint64_view_le_get_range_unsafe(sbe_uint64_view_le view, uint64_t *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
...
struct sbe_float_view_be
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const float *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(const float *ptr)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, 0, length ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    bool set(size_t index, float val)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(size_t index, float val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    bool set(const float *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    void set_unsafe(const float *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get(float *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get_unsafe(float *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    ...
    float get_unsafe(size_t index)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT((*this), index, float ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get(float *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    size_t get_unsafe(float *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
#endif
...
SBE_ONE_DEF bool sbe_float_view_be_set(sbe_float_view_be view, const float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_float_view_be_set_at(sbe_float_view_be view, size_t index, float val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_float_view_be_set_at_unsafe(sbe_float_view_be view, size_t index, float val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_float_view_be_set_range(sbe_float_view_be view, const float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_float_view_be_set_range_unsafe(sbe_float_view_be view, const float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_be_get(sbe_float_view_be view, float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_be_get_unsafe(sbe_float_view_be view, float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF float sbe_float_view_be_get_at(sbe_float_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_FLOAT_NAN, float ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF float sbe_float_view_be_get_at_unsafe(sbe_float_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, float ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_be_get_range(sbe_float_view_be view, float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_be_get_range_unsafe(sbe_float_view_be view, float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_float_view_le_set(sbe_float_view_le view, const float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
...
SBE_ONE_DEF bool sbe_float_view_le_set_at(sbe_float_view_le view, size_t index, float val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_float_view_le_set_at_unsafe(sbe_float_view_le view, size_t index, float val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF bool sbe_float_view_le_set_range(sbe_float_view_le view, const float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF void sbe_float_view_le_set_range_unsafe(sbe_float_view_le view, const float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_le_get(sbe_float_view_le view, float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_le_get_unsafe(sbe_float_view_le view, float *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF float sbe_float_view_le_get_at(sbe_float_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_FLOAT_NAN, float ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF float sbe_float_view_le_get_at_unsafe(sbe_float_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, float ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_le_get_range(sbe_float_view_le view, float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
SBE_ONE_DEF size_t sbe_float_view_le_get_range_unsafe(sbe_float_view_le view, float *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_32, uint32_t);
}
...
struct sbe_double_view_be
{
    ...
    size_t length;
#if defined(__cplusplus)
    bool set(const double *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(const double *ptr)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, 0, length ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    bool set(size_t index, double val)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(size_t index, double val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    bool set(const double *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    void set_unsafe(const double *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get(double *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get_unsafe(double *ptr, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    ...
    double get_unsafe(size_t index)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT((*this), index, double ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get(double *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    size_t get_unsafe(double *ptr, size_t offset, size_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
#endif
...
SBE_ONE_DEF bool sbe_double_view_be_set(sbe_double_view_be view, const double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_double_view_be_set_at(sbe_double_view_be view, size_t index, double val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_double_view_be_set_at_unsafe(sbe_double_view_be view, size_t index, double val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_double_view_be_set_range(sbe_double_view_be view, const double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_double_view_be_set_range_unsafe(sbe_double_view_be view, const double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_be_get(sbe_double_view_be view, double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_be_get_unsafe(sbe_double_view_be view, double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF double sbe_double_view_be_get_at(sbe_double_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_DOUBLE_NAN, double ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF double sbe_double_view_be_get_at_unsafe(sbe_double_view_be view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, double ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_be_get_range(sbe_double_view_be view, double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_be_get_range_unsafe(sbe_double_view_be view, double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_double_view_le_set(sbe_double_view_le view, const double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
...
SBE_ONE_DEF bool sbe_double_view_le_set_at(sbe_double_view_le view, size_t index, double val)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_double_view_le_set_at_unsafe(sbe_double_view_le view, size_t index, double val)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT(view, index, val ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF bool sbe_double_view_le_set_range(sbe_double_view_le view, const double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF void sbe_double_view_le_set_range_unsafe(sbe_double_view_le view, const double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_le_get(sbe_double_view_le view, double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_le_get_unsafe(sbe_double_view_le view, double *data, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, 0, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF double sbe_double_view_le_get_at(sbe_double_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_AT(view, index, SBE_DOUBLE_NAN, double ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF double sbe_double_view_le_get_at_unsafe(sbe_double_view_le view, size_t index)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_AT(view, index, double ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_le_get_range(sbe_double_view_le view, double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_SAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
SBE_ONE_DEF size_t sbe_double_view_le_get_range_unsafe(sbe_double_view_le view, double *data, size_t offset, size_t len)
{
    _SBE_BYTE_ORDER_BUFFER_UNSAFE_GET_RANGE(view, data, offset, len ,SBE_LITTLE_ENDIAN_ENCODE_64, uint64_t);
}
