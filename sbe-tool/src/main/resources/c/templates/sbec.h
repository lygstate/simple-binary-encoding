...
struct sbe_int8_view
{
    ...
    void set_unsafe(uint64_t index, int8_t val)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_AT((*this), index, val);
    }
    ...
    void set_unsafe(const int8_t *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, offset, len);
    }
...
struct sbe_int16_view_be
{
    ...
    void set_unsafe(uint64_t index, int16_t val)
    {
    ...
    void set_unsafe(const int16_t *ptr, uint64_t offset, uint64_t len)
    {
...
struct sbe_int32_view_be
{
    ...
    void set_unsafe(uint64_t index, int32_t val)
    {
    ...
    void set_unsafe(const int32_t *ptr, uint64_t offset, uint64_t len)
    {
...
struct sbe_int64_view_be
{
    ...
    void set_unsafe(uint64_t index, int64_t val)
    {
    ...
    void set_unsafe(const int64_t *ptr, uint64_t offset, uint64_t len)
    {
...
struct sbe_uint8_view
{
    ...
    void set_unsafe(uint64_t index, uint8_t val)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_AT((*this), index, val);
    }
    ...
    void set_unsafe(const uint8_t *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BUFFER_VIEW_UNSAFE_SET_RANGE((*this), ptr, offset, len);
    }
...
struct sbe_uint16_view_be
{
    ...
    void set_unsafe(uint64_t index, uint16_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
    ...
    void set_unsafe(const uint16_t *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_16, uint16_t);
    }
...
struct sbe_uint32_view_be
{
    ...
    void set_unsafe(uint64_t index, uint32_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    ...
    void set_unsafe(const uint32_t *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
...
struct sbe_uint64_view_be
{
    ...
    void set_unsafe(uint64_t index, uint64_t val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    ...
    void set_unsafe(const uint64_t *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
...
struct sbe_float_view_be
{
    ...
    void set_unsafe(uint64_t index, float val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
    ...
    void set_unsafe(const float *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_32, uint32_t);
    }
...
struct sbe_double_view_be
{
    ...
    void set_unsafe(uint64_t index, double val)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_AT((*this), index, val ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
    ...
    void set_unsafe(const double *ptr, uint64_t offset, uint64_t len)
    {
        _SBE_BYTE_ORDER_BUFFER_UNSAFE_SET_RANGE((*this), ptr, offset, len ,SBE_BIG_ENDIAN_ENCODE_64, uint64_t);
    }
